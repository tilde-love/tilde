...
namespace App
{
    ...
    {
        private BoolControl bool1 = new BoolControl("bool1", false); 
        private IntControl int1 = new IntControl("int1", false, 0, 10); 
        private FloatControl float1 = new FloatControl("float1", false, -10, 10, 0.1f); 
        private StringControl string1 = new StringControl("string1", false);
        private EnumControl<TestEnum> enum1 = new EnumControl<TestEnum>("enum1", false); 
