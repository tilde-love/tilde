...
{
    public delegate void ControlValueEvent(
        Uri project,
        Uri control,
        string connectionId,
        object value);
    ...
    {
        [JsonProperty("panels")] public readonly ConcurrentDictionary<Uri, ControlPanel> Panels = new ConcurrentDictionary<Uri, ControlPanel>();

        [JsonProperty("sources")] public readonly ConcurrentDictionary<Uri, DataSource> Sources = new ConcurrentDictionary<Uri, DataSource>();

        [JsonProperty("values")] public readonly ConcurrentDictionary<Uri, object> Values = new ConcurrentDictionary<Uri, object>();
        ...
        public ControlGroup(Project project)
        {
            ...
            foreach (ProjectFile file in project.ProjectFiles.Values)
            {
